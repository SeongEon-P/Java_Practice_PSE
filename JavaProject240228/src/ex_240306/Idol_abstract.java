package ex_240306;
// 추상 클래스로 변경하기.
// 추상 클래스가 뭐냐? 구성을 추상 매서드를 한 개 이상 가지고 있으면, 추상클래스라 한다.
// 추상적이다라고 하는 말은, 약간 대략적인, 아웃라인, 개요.
// 반대가 되는 말이 구체적인 뉘앙스.
// 추상 메서드 뭐냐? 메섣의 기본구성 1)선언부, 2)구현체(몸통) 으로 구성이 되는데 여기서, 2번 빠진 메서드.
// 즉 예)abstract 키워드를 사용하고,
// abstract public void introducAlbum()
