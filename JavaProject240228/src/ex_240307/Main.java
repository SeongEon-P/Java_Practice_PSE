...
//		System.out.println("수영 등록 시간 : " + swimming.getCreateTime());
	...
	//		void showTeamNameOrMember(String[] TeamOrMembers);
		...
		// 야구 선수 소개 
		String [] baseballMembers = {"상용","성언","상준","병건","관우","상현","동진","규원"};
		baseball2.showTeamNameOrMember(members);
		// 야구 아이템 소개 
		String [] baseballItem = {"배트","야구공","글러브","야구모자","유니폼", "야구 신발"};
		baseball2.showUseItems(itemStrings);
